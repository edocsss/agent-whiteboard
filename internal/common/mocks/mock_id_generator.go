...
func (_mock *MockIDGenerator) NewID() (string, error) {
	ret := _mock.Called()
...
func (_c *MockIDGenerator_NewID_Call) Return(s string, err error) *MockIDGenerator_NewID_Call {
	_c.Call.Return(s, err)
	return _c
}

func (_c *MockIDGenerator_NewID_Call) RunAndReturn(run func() (string, error)) *MockIDGenerator_NewID_Call {
	_c.Call.Return(run)
	return _c
}
